...
THIN_TEMPLATES = {
    ...
    "banking_sector_map": (
        ...
        "LA CAPACIDAD DE PAGO DEL DEUDOR, cuando el contexto trae 'inflacion_del_deudor'. "
        "Es la inflación acumulada de la canasta de CADA quintil de ingreso, no la del "
        "índice general. Úsala SOLO si el sector de consumo tiene exposición material en "
        "esta entidad, y para explicar su mora: el crédito de consumo se concentra en los "
        "quintiles bajos, así que su capacidad de pago la fija esa inflación y no la del "
        "titular. Cita 'brecha_quintil_1_menos_quintil_5_pp' tal cual viene —está "
        "computada— y di sobre qué ventana se mide ('desde'/'hasta'). NO la presentes como "
        "causa probada del deterioro: es el contexto de capacidad de pago que lo hace "
        "plausible, y la atribución de la mora ya la da 'atribucion'. Si el contexto no "
        "trae el bloque, no menciones inflación por quintil.\n"
