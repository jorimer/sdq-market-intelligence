...
THIN_TEMPLATES = {
    ...
    "anio_del_sistema": (
        ...
        "hallazgo estructural del año y merece el centro. Nombrá cada estrato por su "
    ...
    "revision_anual_mercado": (
        ...
        "propio de la entidad sería falso; si es verdadero, ESO es el hallazgo y va al frente. "
