...
THIN_TEMPLATES = {
    ...
    "sector_outlook": (
        ...
        "QUÉ EXPLICA EL SCORE: cada dimensión trae 'que_hay_dentro' con sus variables, el valor "
        "YA en la unidad en que se cita y su posición entre los 17 sectores (0-100). Ahí está la "
        "frase accionable: no digas solo que una dimensión lastra, nombra la variable y su valor "
        "—p. ej. la tasa a la que el sistema financiero le presta al sector, o el salario "
        "promedio cotizable—. Copia los valores tal como vienen (la unidad va en el nombre de la "
        "variable) y no conviertas razones a porcentajes ni al revés.\n\n"
