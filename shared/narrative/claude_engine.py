...
THIN_TEMPLATES = {
    ...
    "sector_outlook": (
        ...
        "PARA UBICAR AL SECTOR usá 'puesto_entre_los_sectores_que_tienen_esta_variable', que ya "
        "viene calculado con su denominador ('14 de 16', 1 = el más favorable) y ese denominador "
        "NO siempre son 17 porque no toda fuente alcanza a todos los sectores: cítalo tal cual, "
        "sin cambiarlo por 17. 'posicion_en_la_escala_de_valor_del_panel_0_100' es OTRA cosa y "
