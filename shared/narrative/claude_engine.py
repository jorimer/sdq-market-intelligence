...
THIN_TEMPLATES = {
    ...
    "construction_delta": (
        "Escribí el MOVIMIENTO DEL MES del sector construcción dominicano.\n"
        "Contexto:\n{context}\n\n"
        "Máximo 220 palabras. El sujeto es UN MES de licencias emitidas y el período del "
        "índice anual de este informe es OTRO: no los confundas ni los sumes.\n\n"
        "EL MES LEÍDO SE NOMBRA: usá 'mes_leido' tal cual. Puede no ser el mes en curso, así "
        "que no escribas 'este mes', 'el mes pasado' ni 'la lectura más reciente'. La sección "
        "ya abre con una línea que nombra el mes y, si 'fuente_al_dia' es falso, declara "
        "cuándo publicó la fuente por última vez: NO la repitas ni la contradigas.\n\n"
        ...
        "respaldar. Si te sale escribir un porqué, no lo escribas.\n\n"
        ...
        "período: el mes contra el MISMO mes del año anterior. Escribí contra qué se mide; un "
        "porcentaje sin su base obliga al lector a suponerla y va a suponer mal.\n\n"
        "'ventana_movil_12m', cuando viene disponible, es la magnitud comparable con el "
        "índice anual del informe — es el puente entre este mes y el índice, y vale la pena "
        "nombrarlo. Si trae 'disponible' en falso, NO la menciones como cifra: su motivo dice "
        "por qué no existe.\n\n"
        ...
        "Los m² por provincia y por tipología son del MES, no del año: nombralos así. Los "
        "permisos son un indicador LÍDER —el permiso precede a la obra—, no producción "
        "ejecutada; no escribas que el sector construyó lo que apenas licenció.\n\n"
