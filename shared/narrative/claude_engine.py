...
THIN_TEMPLATES = {
    ...
    "brand_sdq_proposals": (
        "Redacta la sección PLANES QUE SDQ PROPONE del Informe de Contexto de Mercado: "
        "propuestas de acción derivadas de la evidencia medida en este mismo informe."
        "\nContexto:\n{context}\n\n"
