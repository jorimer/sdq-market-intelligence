...
Canonical location (Fase 0): moved here from
``banking_score/external/sib_client.py`` so every axis consumes SIB data through
``shared/data``.  ``banking_score`` re-exports from this module for compatibility.
