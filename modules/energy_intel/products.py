...
class EnergyProduct:
    ...
    def variable_signals(self) -> Dict[str, Any]:
        ...
        Reusa el ``breakdown.dimensions`` persistido (``provenance`` "real"/"brecha" +
        peso) y la fuente/cadencia que el propio producto ya declara — sin fabricar."""
    ...
    def snapshot(self, tier: ProductTier, period: str,
        ...
        try:
            ...
            logger.exception("Perfil del sector omitido en el snapshot de energia")
        ...
        try:
            ...
            logger.exception("Capacidad de pago omitida en el snapshot de energy_intel")
