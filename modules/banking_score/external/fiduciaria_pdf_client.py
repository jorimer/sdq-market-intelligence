...
# ─── Line-item helpers + mapeo de entidad: movidos a shared/pdf/fields (los
# reusa pension_intel; la violación cross-módulo era deuda del DD). map_entity_fields
# se re-exporta acá para los callers históricos (fc.map_entity_fields).
from shared.pdf.fields import (  # noqa: E402,F401
    _find_equity_result,
    _find_total,
    _last_income_total,
    _sum_matching,
