...
pregunta. Código nuevo importa de ``shared.data.simbad_client``.
...
que parece público — hay tests que importan privados (`_post_chart_data`). Una lista escrita a mano se
queda corta justo en el símbolo que alguien agregó después.
"""
from shared.data.simbad_client import (  # noqa: F401
    DATASET_BALANCE,
    DATASET_INCOME,
    SIMBAD_BASE,
    _post_chart_data,
    extract_cambiaria_bulk,
    logger,
)
