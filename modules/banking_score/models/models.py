...
# ─── CarteraSectorial ─────────────────────────────────────────────
# MUDADA a `shared/reference/cartera_sectorial.py` (fase 1 del plan de enriquecimiento
# sectorial). Es un registro NACIONAL de crédito —todas las supervisadas, 19 sectores, 33
# provincias— y once productos van a leerlo; ningún eje es su dueño. La tabla se llama igual
# (`cartera_sectorial`), así que la mudanza no llevó migración.
