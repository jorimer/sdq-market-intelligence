...
SAMPLE_NARRATIVES = {
    ...
    "soporte_soberano": (
        ...
        "Fitch, el soporte se lee en dos patas: la **propensión** (por su tamaño sistémico, "
        "no por propiedad) existe, pero la **capacidad** está **acotada** por un soberano de "
        "grado especulativo (RD BB) con margen fiscal limitado —un rescate lo costea el "
        "soberano, no la doctrina—, de modo que el soporte es **incierto, no asumido**. El "
