...
evidence/sensor_guard_prod_dump_v4.json para auditar.
"""
import json
import sys
import time
...
def main():
    ...
    with open("evidence/sensor_guard_prod_dump_v4.json", "w") as f:
        json.dump(out, f, ensure_ascii=False, indent=2)
    print("OK -> evidence/sensor_guard_prod_dump_v4.json", file=sys.stderr)
