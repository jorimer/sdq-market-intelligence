...
- **i18n multilingüe ES/EN/FR** — **por fases.** Fase 1 (toggle + marco, #238) y Fase 2 (narrativas IA por idioma, #240) **EN PROD**; **Fase 3 en curso** (barrido por eje, cada uno 1 PR): piloto ESG + widgets compartidos en prod (#242); pendientes sector/regulatorio/social/comercio/macro/banca/platform. Ver [[i18n-multilang]].
