...
- **i18n multilingüe ES/EN/FR** — **por fases.** Fase 1 (toggle + marco, #238) y Fase 2 (narrativas IA por idioma, #240) **EN PROD**; **Fase 3 en curso** (barrido por eje, cada uno 1 PR): ESG (#242) + widgets compartidos · Regulatorio (#244) + bands.ts · Sectorial (#245) · Social (#246) en prod; pendientes comercio/macro/banca/platform + sección Datos. Ver [[i18n-multilang]].
