...
- **i18n multilingüe ES/EN/FR** — **por fases.** Fase 1 (toggle ES/EN/FR + marco traducido) **EN PROD (#238)**; pendientes Fase 2 (narrativas IA en el idioma) y Fase 3 (barrido ~1000 strings por eje). Ver [[i18n-multilang]].
