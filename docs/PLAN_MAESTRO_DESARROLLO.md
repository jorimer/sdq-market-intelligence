...
- **i18n multilingüe ES/EN/FR** — **por fases.** Fase 1 (toggle + marco, #238) y Fase 2 (narrativas IA por idioma vía header X-Lang + dependencia global, #240) **EN PROD**; pendiente Fase 3 (barrido ~1000 strings por eje). Ver [[i18n-multilang]].
