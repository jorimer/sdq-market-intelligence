...
| **B2 · concluyente, pero sin ventaja sobre ordenar por tamaño** | discriminación contra un desenlace realizado, **sin poder afirmar ventaja**: el mismo desenlace ordenado SOLO por el tamaño del sujeto alcanza un poder indistinguible del score — o directamente mejor. La cifra es real y se cita; lo que NO se puede decir es que el score aporte algo que el tamaño no explique. Medido el 2026-09-01, **tres de las cinco filas del grupo B empataban con el tamaño** y la tabla no lo decía. Al llegar el control de banca ese mismo día apareció el caso peor: el activo total ordena el desenlace con **0,5553** contra **0,2489** del score, con los intervalos sin tocarse. El rótulo dice «sin ventaja» y no «indistinguible» justamente porque cubre las dos |
